...
<html>
  <head>
	...
	<script>
	function topPage() {
		window.self.location = "manager.do?command=findRecord&pageNo=${pagemodel.topPageNo}&pageSize=${managerForm.pageSize}"
	}
	function previousPage() {
		window.self.location = "manager.do?command=findRecord&pageNo=${pagemodel.previousPageNo}&pageSize=${managerForm.pageSize}"
	}	
	
	function nextPage() {
		window.self.location = "manager.do?command=findRecord&pageNo=${pagemodel.nextPageNo}&pageSize=${managerForm.pageSize}"
	}
	
	function bottomPage() {
		window.self.location = "manager.do?command=findRecord&pageNo=${pagemodel.bottomPageNo}&pageSize=${managerForm.pageSize}"
	}
	</script>
  </head>
