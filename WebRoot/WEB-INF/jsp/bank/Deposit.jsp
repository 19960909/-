...
<html>
  <head>
	...
	function check1(){
	var f = document.form;
		if( f.deposit_money.value==""){
			alert("ÇëÊäÈë´æ¿î½ð¶î");
			
			f.deposit_money.focus();
			return false;
		}
  ...
  <body >
    	...
    	<form name="form" action="manager.do?command=Deposit" method="post">
    	<div class="mid" >
    		<tr>
    			<td><bean:message key="enter.deposit"/>£º</td><td><input type="text" name="deposit_money"  ></td><br>
    		</tr>
